...
- "check\_lazyIndex\_in_use" and reorder.   
...
- c(LazyList), add checking validity.   -- done! but does not check automatically...
- rbind, cbind. c(DDF, DDF)   -- works! Do more checking. 
