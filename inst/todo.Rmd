...
- test stats functions with real VCF data.   -- done!
  -- save any results into VE? seqAlleleFrequency, seqAlleleCount, seqMissing(variant/sample)...? 
  -- sample.annotation related stat analysis: mendelian errors? (use family info, test!!)
  -- association test associated analysis? 
...
- add testthat functions for VCF2VE and other stats functions.
  ...
  -- matrix values returned from stats functions, return as GDSArray? or ordinary array? 
	  "refDosage", "altDosage", ...same dimension as genotype array. 
  -- check "test_saveGDSSummarizedExperimentFrom" for 3 errors. 
